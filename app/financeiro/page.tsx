      ...
      <div className="space-y-6">
            ...
            <Card>
              <CardContent className="flex items-center justify-between p-4">
                <div>
                  ...
                  <p className="text-2xl font-bold">R$ 130.000</p>
            ...
            <Card>
              <CardContent className="flex items-center justify-between p-4">
                <div>
                  ...
                  <p className="text-2xl font-bold">R$ 69.000</p>
            ...
            <Card>
              <CardContent className="flex items-center justify-between p-4">
                <div>
                  ...
                  <p className="text-2xl font-bold text-emerald-500">R$ 61.000</p>
                  <div className="flex items-center gap-1 text-xs text-emerald-500">
                    <ArrowUpRight className="h-3 w-3" />
                    <span>Margem: 46.9%</span>
                  </div>
                </div>
          ...
          <CardContent>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={mockFinancial.cashFlow}>
                  <defs>
                        ...
                        return (
                          <div className="rounded-lg border bg-background p-3 shadow-lg">
                            ...
                            <p className="text-sm text-destructive">
                              Despesa: R$ {payload[1].value?.toLocaleString("pt-BR")}
                            </p>
                          </div>
                        )
                      }
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Total: R$ {mockFinancial.accountsPayable.reduce((sum, a) => sum + a.value, 0).toFixed(2).replace(".", ",")}
                  </CardDescription>
                </div>
                <Button size="sm">
            ...
            <CardContent>
              <div className="space-y-3">
                {mockFinancial.accountsPayable.map((account, index) => (
                  <motion.div
                    key={account.id}
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Total: R$ {mockFinancial.accountsReceivable.reduce((sum, a) => sum + a.value, 0).toFixed(2).replace(".", ",")}
                  </CardDescription>
                </div>
                <Button size="sm">
                  <Plus className="mr-2 h-4 w-4" />
            ...
            <CardContent>
              <div className="space-y-3">
                {mockFinancial.accountsReceivable.map((account, index) => (
                  <motion.div
                    key={account.id}
                    initial={{ opacity: 0, x: 20 }}
                    animate={{ opacity: 1, x: 0 }}
